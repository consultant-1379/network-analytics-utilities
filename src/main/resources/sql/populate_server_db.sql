/*
 * Copyright (c) 2018-2022 Spotfire AB,
...
insert into SN_VERSION (SPOTFIRE_VERSION, SCHEMA_VERSION) values ('68.5.13725.4658', '470');

-- Special groups
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('19e7e430-9997-11da-fbc4-0010ac110215', 'Everyone', 'SPOTFIRE', 'Everyone', false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED,CREATED)
  values ('fed6b2b0-a9e1-11da-8ed2-0010ac110222', 'Administrator', 'SPOTFIRE', 'Administrator', false, true,
    (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('a92097e0-07a7-11db-fd44-0010c0a8019b', 'Library Administrator', 'SPOTFIRE', 'Library Administrator', false,
    true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('96b90a10-1d4d-11de-283a-00100a64216b', 'Scheduled Updates Users', 'SPOTFIRE', 'Scheduled Updates Users',
    false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('5071c63a-b6ca-4f37-aeee-b141be843dda', 'Deployment Administrator', 'SPOTFIRE', 'Deployment Administrator',
    false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('5bd69e2b-6685-4dd6-9858-8990c46c522b', 'Diagnostics Administrator', 'SPOTFIRE', 'Diagnostics Administrator',
    false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('4dd3fc65-c727-474b-976c-96b807f36bd6', 'Web Player Administrator', 'SPOTFIRE', 'Web Player Administrator',
    false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('5f1879fa-2cca-4d03-b47b-ef03e55d927e', 'Scheduling and Routing Administrator', 'SPOTFIRE', 
    'Scheduling and Routing Administrator', false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('6c677f0f-3cbe-4615-85be-8366c7ce3181', 'Script Author', 'SPOTFIRE', 'Script Author', false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('2cbe823f-1507-4b56-a822-621f431ee061', 'Custom Query Author', 'SPOTFIRE', 'Custom Query Author', false,
    true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('3bf79f12-1842-41d5-9002-fa1d70ce071c', 'Anonymous User', 'SPOTFIRE', 'Anonymous User', false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('5a544e10-f305-408b-ae0c-a602eec4ed4f', 'System Account', 'SPOTFIRE', 'System Account', false, true, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('6dc28196-994b-45a9-a289-ac1b9dca9208', 'Automation Services Users', 'SPOTFIRE', 'Automation Services Users',
    false, true, (select TS from UTC_TIME));
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED, CREATED) 
  values ('6679bcea-758d-4b72-8d50-32dfa6621239', 'guest', 'ANONYMOUS', 'Guest', false, true, (select TS from UTC_TIME));
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED, CREATED) values 
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED, CREATED) values 
  ('3ab9a272-8803-4a2c-85f1-95d9916c9f4c','scheduledupdates','SPOTFIRESYSTEM', 'Scheduled Updates System Account',
    true,  true, (select TS from UTC_TIME));
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED, CREATED) values 
  ('ba65162e-4958-4fa8-a744-87e003770944','automationservices','SPOTFIRESYSTEM', 'Automation Services System Account', 
    true, true, (select TS from UTC_TIME));
insert into GROUP_MEMBERS (GROUP_ID, MEMBER_USER_ID) values 
...
-- Library root item
insert into LIB_CURRENT_ITEMS values ('6b67ec30-712e-11dd-7434-00100a64217d', null, 'root', null, '4f83cd41-71b5-11dd-050e-00100a64217d', null, CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP, null, null, '0');
...
insert into LIB_CURRENT_ITEMS values ('4dad81b0-4e2b-44ff-9a6d-ff7b5c862649', null, 'RelatedItems', null, '4f83cd41-71b5-11dd-050e-00100a64217d', null, CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP, null, '6b67ec30-712e-11dd-7434-00100a64217d', '1');

-- AnalysisStates library hidden folder (Everyone)
insert into LIB_CURRENT_ITEMS values ('864d749e-794c-477f-87ea-03be54fded87', null, 'AnalysisStates', null, '4f83cd41-71b5-11dd-050e-00100a64217d', null, CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP, null, '4dad81b0-4e2b-44ff-9a6d-ff7b5c862649', '1');
...
insert into LIB_CURRENT_ITEMS values ('6fdbc6a1-a719-465b-b6ef-94261459a497', null, 'Tasks', null, '4f83cd41-71b5-11dd-050e-00100a64217d',  null, CURRENT_TIMESTAMP, null, CURRENT_TIMESTAMP, null, '4dad81b0-4e2b-44ff-9a6d-ff7b5c862649', '1');
